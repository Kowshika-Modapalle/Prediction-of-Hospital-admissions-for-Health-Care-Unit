...
load('C:/Users/kowsh/OneDrive/Desktop/Project/admissionprediction-1.0/Results/5v_cleandf.RData')

#2) Create a list of indeces for model fitting
source('C:/Users/kowsh/OneDrive/Desktop/Project/admissionprediction-1.0/Scripts/R/20b_splitdataindex.R')
indeces_list <- splitdataindex(df)
save(indeces_list, file = 'C:/Users/kowsh/OneDrive/Desktop/Project/admissionprediction-1.0/Results/5v_indeces_list.RData')

#3) Re-encode dataframe into design matrix x and response y
source("C:/Users/kowsh/OneDrive/Desktop/Project/admissionprediction-1.0/Scripts/R/21_makematrix.R")
dataset <- makematrix(df, sparse = T)
save(dataset, file = 'C:/Users/kowsh/OneDrive/Desktop/Project/admissionprediction-1.0/Results/5v_sparseMatrix.RData')

#4) Start CV
source('C:/Users/kowsh/OneDrive/Desktop/Project/admissionprediction-1.0/Scripts/R/25_fitboost.R')
